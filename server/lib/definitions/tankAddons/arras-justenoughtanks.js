...
const { combineStats, menu, makeAuto, makeOver, makeBattle, makeDeco, makeGuard, makeBird, makeRadialAuto, weaponArray } = require('../facilitators.js');
const { base, statnames, dfltskl, smshskl } = require('../constants.js');
const g = require('../gunvals.js');

let g2 = {
    torrent: {reload: 0.75, recoil: 0.8, shudder: 1.2, size: 10/12, health: 0.9, damage: 0.9, maxSpeed: 0.9, spray: 1.5},
    cascade: {reload: 0.5, recoil: 0.9, shudder: 1.5, health: 0.95, damage: 0.95, spray: 2},
    soaker: {reload: 0.5, recoil: 0.6, shudder: 1.6, health: 0.8, damage: 0.8, maxSpeed: 0.8, spray: 2.5},
    minisassin: {reload: 1.35, shudder: 0.85, health: 1.15, damage: 1.1, pen: 1.1, speed: 1.25, maxSpeed: 1.1, resist: 1.3},
    hex: {recoil: 0.75, health: 0.95, damage: 0.85, pen: 0.95},
    assault: {reload: 0.7, recoil: 0.7, shudder: 1.3, damage: 0.9, health: 0.9},
    machineRifle: { reload: 0.8, recoil: 0.8, shudder: 1.5, health: 0.9, damage: 0.9, pen: 0.9, spray: 1.5 }, 
...
Class.justEnoughTanks = menu("Just Enough Tanks")
Class.justEnoughTanks.UPGRADES_TIER_0 = ["jetAbomination","jetFlak",["machineGun","overseer"]];
Class.addons.UPGRADES_TIER_0.push("justEnoughTanks");

Class.jetCombination = makeOver('pounder', "Combination", {count: 1, independent: true, cycle: false});
Class.jetFusion = makeOver('pounder', "Fusion", {count: 3, maxDrones: 2, angle: 90});
Class.jetChimera = makeBattle('pounder', "Chimera", {count: 1, independent: true});
...
Class.jetFlak = {
    ...
    GUNS: [
        ...
        },
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.pounder, { reload: 1.6, damage: 0.2}]),
                TYPE: "jetFlakBullet"
            }
        }
    ]
    ...
    GUNS: [
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.machineGun, g2.torrent]),
                TYPE: "bullet"
            }
        }
    ]
    ...
    GUNS: [
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.machineGun, g2.torrent, g2.cascade]),
                TYPE: "bullet"
            }
        }
    ]
    ...
    GUNS: [
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.machineGun, g2.torrent, g.lowPower, g.pelleter, { recoil: 1.15, size: 12/10, shudder: 0.9 }]),
                TYPE: "bullet"
            }
        },
        {
...
Class.jetQuickDraw = {
    ...
    GUNS: [
        ...
        },
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.sniper, g.rifle, g.assassin]),
                TYPE: "bullet",
            } 
        }, 
        {
    ...
    GUNS: [ 
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.minigun, g2.minisassin]),
                TYPE: "bullet"
            } 
        },
        {
    ...
    GUNS: [
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.twin, g.gunner, g2.hex, { speed: 1.2 }]),
                TYPE: "bullet"
            }
        },
        {
...
Class.jetAssaultRifle = {
    ...
    GUNS: [
        ...
        },
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.sniper, g.rifle, g2.assault]),
                TYPE: "bullet"
            }
        }
    ]
    ...
    GUNS: weaponArray([
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.twin, g.gunner, g.doubleTwin, { speed: 1.2 }]),
                TYPE: "bullet"
            }
        },
        {
    ...
    GUNS: [
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.twin, g.gunner, g.focal, { maxSpeed: 1.2, speed: 1.5, spray: 0.5 }]),
                TYPE: "bullet"
            }
        },
        {
...
Class.jetMachineRifle = {
    ...
    GUNS: [
        ...
        },
        {
            POSITION: [14, 10, 1.3, 8, 0, 0, 0],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.machineGun, g.focal, g2.machineRifle]),
                TYPE: "bullet",
            },
        },
    ],
...
Class.jetHexaMachineGun = {
    ...
    GUNS: weaponArray(
        [{
            ...
            PROPERTIES: 
            {
                SHOOT_SETTINGS: combineStats([g.basic, g.flankGuard, g.flankGuard, g.machineGun]),
                TYPE: "bullet",
            }
        },{
...
Class.jetBurst = {
    ...
    GUNS: weaponArray(
        [{
            ...
            PROPERTIES: 
            {
                SHOOT_SETTINGS: combineStats([g.basic, g.flankGuard, g.flankGuard, g.pounder]),
                TYPE: "bullet",
            }
        },{
...
Class.jetBentMinigun = {
    ...
    GUNS: [ { /*** LENGTH  WIDTH   ASPECT    X       Y     ANGLE   DELAY */
        POSITION: [  18,     8,      1,      0,     -2,     -17.5,   0.25,  ], 
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.minigun, g.tripleShot, {recoil: 0.5}]),
                TYPE: "bullet",
            }, }, {
    ...
    GUNS: [
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.pounder, g.artillery, g.tripleShot, g2.battery]),
                TYPE: "bullet",
            },
        },
        {
...
Class.sniper.UPGRADES_TIER_2.splice(Class.sniper.UPGRADES_TIER_2.indexOf("marksman"),1);
Class.sniper.UPGRADES_TIER_3.splice(Class.sniper.UPGRADES_TIER_3.indexOf("railgun"),1);
Class.rifle.UPGRADES_TIER_3.splice(Class.sniper.UPGRADES_TIER_3.indexOf("revolver"),1);
Class.hunter.UPGRADES_TIER_3.splice(Class.hunter.UPGRADES_TIER_3.indexOf("nimrod"),1);
Class.assassin.UPGRADES_TIER_3.splice(Class.assassin.UPGRADES_TIER_3.indexOf("deadeye"),1);
Class.assassin.UPGRADES_TIER_3.splice(Class.assassin.UPGRADES_TIER_3.indexOf("single"),1);
Class.spawner.UPGRADES_TIER_3.splice(Class.spawner.UPGRADES_TIER_3.indexOf("ranch"), 1);
Class.auto3.UPGRADES_TIER_3.splice(Class.auto3.UPGRADES_TIER_3.indexOf("whirl3"), 1);
Class.trapGuard.UPGRADES_TIER_3.splice(Class.trapGuard.UPGRADES_TIER_3.indexOf("whirlGuard"),1);
Class.hexaTank.UPGRADES_TIER_3.splice(Class.hexaTank.UPGRADES_TIER_3.indexOf("hexaWhirl"), 1);
Class.artillery.UPGRADES_TIER_3.splice(Class.artillery.UPGRADES_TIER_3.indexOf("munition"), 1);
Class.launcher.UPGRADES_TIER_3.splice(Class.launcher.UPGRADES_TIER_3.indexOf("vortex"),1);
Class.underseer.UPGRADES_TIER_3.splice(Class.underseer.UPGRADES_TIER_3.indexOf("prophet"),1);
if(!Class.basic.UPGRADES_TIER_3) 
  Class.basic.UPGRADES_TIER_3 = [];
Class.basic.UPGRADES_TIER_3.push("single");
Class.smasher.UPGRADES_TIER_3.splice(Class.smasher.UPGRADES_TIER_3.indexOf("cocci"),1);

Class.machineGun.UPGRADES_TIER_2.push("jetLongshot","jetTorrent");
if(!Class.machineGun.UPGRADES_TIER_3) 
...
Class.tripleShot.UPGRADES_TIER_3.push("jetMultiShot","jetBentMinigun","jetBattery");
Class.rifle.UPGRADES_TIER_3.push("jetNimrod","jetQuickDraw","jetAssaultRifle","jetMachineRifle");
Class.hunter.UPGRADES_TIER_3.push("jetNimrod");
Class.assassin.UPGRADES_TIER_3.push("jetMinisassin","jetQuickDraw");
Class.minigun.UPGRADES_TIER_3.push("jetMinisassin","jetBentMinigun","jetSoaker");
...
Class.jetLongshot.UPGRADES_TIER_3 = ["jetMinisassin","focal","jetLongGunner","jetMachineRifle"];
    ...
    GUNS: [
        {
            ...
            PROPERTIES: {
                AUTOFIRE: true,
                SHOOT_SETTINGS: combineStats([g.basic, g.lowPower, {speed: 1.1, maxSpeed: 1.1, reload: 0.75}]),
                TYPE: [ "bullet", { PERSISTS_AFTER_DEATH: true } ],
                STAT_CALCULATOR: "thruster",
                WAIT_TO_CYCLE: true,
            }
...
for(let i = 0; i < 10; i++) {
    Class.spreadshot.GUNS[i].PROPERTIES.SHOOT_SETTINGS.reload = Class.spreadshot.GUNS[10].PROPERTIES.SHOOT_SETTINGS.reload;
    Class.spreadshot.GUNS[i].PROPERTIES.SHOOT_SETTINGS.speed = Class.spreadshot.GUNS[10].PROPERTIES.SHOOT_SETTINGS.speed;
    Class.spreadshot.GUNS[i].PROPERTIES.SHOOT_SETTINGS.maxSpeed = Class.spreadshot.GUNS[10].PROPERTIES.SHOOT_SETTINGS.maxSpeed;
}