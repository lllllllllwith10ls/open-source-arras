...
const { combineStats, makeMenu, makeAuto, makeOver, makeBattle, makeDeco, makeGuard, makeBird, makeRadialAuto, weaponArray } = require('../facilitators.js');
...
Class.jetChimera = makeOver('pounder', "Chimera", {spawnerType: "swarm", count: 1, independent: true});
