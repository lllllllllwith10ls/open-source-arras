...
const { combineStats, skillSet, makeMenu, makeRare, weaponArray, makeTurret } = require('../facilitators.js')
const g = require('../gunvals.js');




Class.nest2 = makeMenu("Nest 2.0");
Class.nest2.UPGRADES_TIER_0 = ["nest2Enemies", "nest2Bosses"];
Class.nest2Enemies = makeMenu("Enemies");
...
Class.nest2Bosses = makeMenu("Bosses");
Class.nest2Bosses.UPGRADES_TIER_0 = ["eliteBomber","eliteFighter","spectator2"];
Class.menu_addons.UPGRADES_TIER_0.push("nest2");
